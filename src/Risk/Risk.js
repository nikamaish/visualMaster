    ...
    return (
        ...
        <div className='risk'>
            <div className='riskwarning'>
                ...
                temporary disruptions in data access. Users should remember to use this information at their own risk and consult 
                ...
                legal and regulatory requirements when using our tool. By utilizing our Real-Time Data Visualization Dashboard, you acknowledge these 
